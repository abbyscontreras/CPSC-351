...
<div id="wrapper">
    <main>
        <form method="post">
            <div>
                <label for="student" class="mb-2">Select a student you would like view meeting notes for:</label><br><br>
                ...
                <button type="submit" name="viewstudent" class="btn btn-md btn-secondary mb-4">View Student Meeting Notes
                </button>
            </div>
        </form>
    </main>
